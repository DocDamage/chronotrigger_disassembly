# Chrono Trigger Resume Checklist — `C6:AE00..C6:B7FF`

## Current resume state
- working branch: `live-work-from-pass166`
- ROM: `rom/Chrono Trigger (USA).sfc`
- practical live seam: `C6:AE00..`
- last continuation note in force: `docs/sessions/chrono_trigger_session15_continue_notes_50.md`
...
- the long run from `C5:3B00` through `C6:ADFF` has still produced **0 promotions**
- do **not** go into `C6:AE00..B7FF` assuming the lane is about to turn clean
...
Acceptable outcomes:
- all ten pages freeze honestly and the seam advances to `C6:B800..`
...
1. Read `reports/c6_ae00_b7ff_seam_block.md` first.
...
- the block yields no promotions and the new live seam is cleanly `C6:B800..`
