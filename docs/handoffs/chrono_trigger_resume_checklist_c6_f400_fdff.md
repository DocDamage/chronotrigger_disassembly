# Chrono Trigger Resume Checklist — `C6:F400..C6:FDFF`

## Current resume state
- working branch: `live-work-from-pass166`
- ROM: `rom/Chrono Trigger (USA).sfc`
- practical live seam: `C6:F400..`
- last continuation note in force: `docs/sessions/chrono_trigger_session15_continue_notes_57.md`
...
- the long run from `C5:3B00` through `C6:F3FF` has still produced **0 promotions**
- do **not** go into `C6:F400..FDFF` assuming the lane is about to turn clean
...
Acceptable outcomes:
- all ten pages freeze honestly and the seam advances to `C6:FE00..`
...
1. Read `reports/c6_f400_fdff_seam_block.md` first.
...
- the block yields no promotions and the new live seam is cleanly `C6:FE00..`
