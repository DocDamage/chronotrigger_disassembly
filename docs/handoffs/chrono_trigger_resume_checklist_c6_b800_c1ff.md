# Chrono Trigger Resume Checklist — `C6:B800..C6:C1FF`

## Current resume state
- working branch: `live-work-from-pass166`
- ROM: `rom/Chrono Trigger (USA).sfc`
- practical live seam: `C6:B800..`
- last continuation note in force: `docs/sessions/chrono_trigger_session15_continue_notes_51.md`
...
- the long run from `C5:3B00` through `C6:B7FF` has still produced **0 promotions**
- do **not** go into `C6:B800..C1FF` assuming the lane is about to turn clean
...
Acceptable outcomes:
- all ten pages freeze honestly and the seam advances to `C6:C200..`
...
1. Read `reports/c6_b800_c1ff_seam_block.md` first.
...
- the block yields no promotions and the new live seam is cleanly `C6:C200..`
