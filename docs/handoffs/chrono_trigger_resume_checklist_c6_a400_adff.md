# Chrono Trigger Resume Checklist — `C6:A400..C6:ADFF`

## Current resume state
- working branch: `live-work-from-pass166`
- ROM: `rom/Chrono Trigger (USA).sfc`
- practical live seam: `C6:A400..`
- last continuation note in force: `docs/sessions/chrono_trigger_session15_continue_notes_49.md`
...
- the long run from `C5:3B00` through `C6:A3FF` has still produced **0 promotions**
- do **not** go into `C6:A400..ADFF` assuming the lane is about to turn clean
...
Acceptable outcomes:
- all ten pages freeze honestly and the seam advances to `C6:AE00..`
...
python3 tools/scripts/run_seam_block_v1.py --rom 'rom/Chrono Trigger (USA).sfc' --start C6:A400 --pages 10 --json > reports/c6_a400_adff_seam_block.json
python3 tools/scripts/render_seam_block_report_v1.py --input reports/c6_a400_adff_seam_block.json --output reports/c6_a400_adff_seam_block.md
```

## Work order for the block
1. Read `reports/c6_a400_adff_seam_block.md` first.
...
- the block yields no promotions and the new live seam is cleanly `C6:AE00..`
