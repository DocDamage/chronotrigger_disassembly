# Chrono Trigger Resume Checklist — `C6:D600..C6:DFFF`

## Current resume state
- working branch: `live-work-from-pass166`
- ROM: `rom/Chrono Trigger (USA).sfc`
- practical live seam: `C6:D600..`
- last continuation note in force: `docs/sessions/chrono_trigger_session15_continue_notes_54.md`
...
- the long run from `C5:3B00` through `C6:D5FF` has still produced **0 promotions**
- do **not** go into `C6:D600..DFFF` assuming the lane is about to turn clean
...
Acceptable outcomes:
- all ten pages freeze honestly and the seam advances to `C6:E000..`
...
1. Read `reports/c6_d600_dfff_seam_block.md` first.
...
- the block yields no promotions and the new live seam is cleanly `C6:E000..`
