...
- Extracted seam targets: **12**

## Live seam text

next clean follow-on callable family: C2:E163..C2:E34A immediate structural hints already visible in that follow-on family: exact owner begins at C2:E163 one downstream exact owner visibly begins at C2:E189 local exact 7-byte table is rooted at C2:E1D9 local exact 5-word pointer table is rooted at C2:E1E0 local exact indirect dispatch table is rooted at C2:E298 broader gameplay-facing nouns: 7E:0F0F 7E:0D1F broader gameplay/system role of 7E:0D8B broader gameplay/system role of 7E:0D8C broader gameplay/system role of 7E:0D90 broader top-level family noun: C2:A886..C2:AA30

## Target packet

### C2:E163..C2:E34A

- Span: `C2:E163 .. C2:E34A` (488 bytes)
- Start bytes ±8: `24 36 20 ED A3 28 60 08 E2 20 20 20 88 7B AD C8 0F`
- End bytes ±8: `06 B0 03 8C 06 0F 28 60 08 E2 20 AD 06 0F C9 05 90`
- Overlapping labels:
  - none
- Nearby labels:
  - pass 141 [strong] `C2:E150..C2:E162` :: ct_c2_short_latched_selector_marker_writer_wrapper_mirroring_54_to_77_then_running_a3ed_3624
- Xref summary:
...
- Note mentions:
  ...
  - `chrono_trigger_disasm_pass134.md`
...
- Note mentions:
  - `chrono_trigger_disasm_pass141.md`
  - `chrono_trigger_labels_pass141.md`

### C2:E189

- Start bytes ±8: `E1 A2 F1 FB 20 85 83 28 60 08 E2 30 20 6E 91 AD BA`
- Overlapping labels:
  - none
- Nearby labels:
  - pass 141 [strong] `C2:E150..C2:E162` :: ct_c2_short_latched_selector_marker_writer_wrapper_mirroring_54_to_77_then_running_a3ed_3624
...
- Start bytes ±8: `20 31 ED AD C9 04 20 F3 F2 28 60 36 38 3B 39 37 3A`
- Overlapping labels:
  - none
- Nearby labels:
  - none
...
- Start bytes ±8: `F3 F2 28 60 36 38 3B 39 37 3A 3C ED E1 1E E2 36 E2`
- Overlapping labels:
  - none
- Nearby labels:
  - none
...
- Start bytes ±8: `A2 E3 FB 20 85 83 28 60 D6 E2 CC E2 AA E2 A0 E2 AD`
- Overlapping labels:
  - none
- Nearby labels:
  - none
- Xref summary:
  - C2:E27D JSR (abs,X) bank-local -> C2:E298
- Note mentions:
  - none
...
- Note mentions:
  ...
  - `chrono_trigger_next_session_start_here_pass134.md`
